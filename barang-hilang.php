...
<html lang="en">
    <head>
    <meta http-equiv="refresh" content="3;url=https://cobabaru-assetmovement.000webhostapp.com/barang-hilang.php">
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">

        <link rel="stylesheet" href="styles.css">
        <title>History Missing Asset</title>
        ...
        <div class="hamburger">
            ...
            <label class="logo">AssetNotifX</label>
                <ul>
                    ...
                    <li><a class="active" href="barang-hilang.php">Missing</a></li>
                </ul>
            </div>
        </nav>
</link>
...
<h1> <center>History Missing Asset</center> </h1>
<center>
<table border="1">
    <tr>
        <th width = 50> NO </th>
    ...
    include "db_conn.php";
    $no=1;
    $data = mysqli_query($conn, "select * from tbhistorymissing");
...
<br><br><center><a href="hapushistorymissing.php" class = "button" onclick = "return confirm('Yakin data akan dihapus? Data tidak dapat dikembalikan lagi');" > RESET!!! </a></center>
